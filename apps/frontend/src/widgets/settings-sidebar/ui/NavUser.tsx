...
const menuItemClass =
  "gap-2 px-2 py-1.5 text-sm data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground";
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="bg-popover text-popover-foreground border-border w-[calc(var(--radix-dropdown-menu-trigger-width)+8px)] min-w-56 rounded-md p-1"
            side="top"
            align="start"
            alignOffset={-4}
            sideOffset={8}
